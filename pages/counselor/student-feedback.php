...
<head>
    ...
    <style>
        ...
        .review-card.is-unread { border-left: 3px solid var(--accent-color); }
        .review-card-top {
            display: flex;
        ...
        <div class="main-content">
            ...
            <div class="page-hero">
                <div>
                    ...
                    <p class="page-hero-text">See how students rated their counseling sessions, appointments, and events, and read their comments.</p>
                </div>
            </div>
