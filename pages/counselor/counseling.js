        ...
        <div class="sh-case-day">
            ...
            <div class="sh-case-note-row">
                ...
                <div class="sh-case-note-body">
                    ...
                    ${record.referralCode ? `<div style="margin-top:8px;"><a href="referral-status.php?id=${encodeURIComponent(record.referralCode)}" class="btn btn-outline btn-sm"><i class="bi bi-box-arrow-up-right"></i> View Referral</a></div>` : ''}
                </div>
            </div>
        </div>`;
