...
function loadAppointmentRequests() {
    ...
    const apiUrl = `../../api/appointment-request.php?school=${encodeURIComponent(user.school_attended)}&role=other-school&grade_scope=${encodeURIComponent(getCurrentGradeScope())}`;
...
function viewRequestDetails(requestId) {
    ...
    const apiUrl = `../../api/appointment-request.php?school=${encodeURIComponent(getCurrentSchool())}&role=other-school&grade_scope=${encodeURIComponent(getCurrentGradeScope())}`;
