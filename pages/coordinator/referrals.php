        ...
        <div class="main-content">
            ...
            <div class="page-hero">
                <div>
                    ...
                    <h2 class="page-hero-title">Referrals Management</h2>
                    <p class="page-hero-text">Review and manage all student referrals, track case status, and coordinate with counselors and teachers.</p>
                </div>
            </div>
